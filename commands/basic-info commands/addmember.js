...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    botcmdcsatorna.send(embedxdd);
     ...
     if(!args[0]) return message.channel.send(`<a:x_:736342460522823768> Kérlek jelöld meg azt a felhasználót, akit hozzá szeretnél adni a tickethez! (**${prefix}addmember [@név/név]**)`);
     if(!mentionedUser) return message.channel.send(`**${args[0]}** nem egy felhasználó!`);
     if(regex == false) return message.channel.send(`<a:x_:736342460522823768> A saját ticketedben használd a parancsot!`);
     message.channel.updateOverwrite(mentionedUser.id, { VIEW_CHANNEL: true });
     message.channel.send(`<a:pipa:736339378372214915> ${mentionedUser} sikeresen hozzáadva a tickethez!`);
  }
}
